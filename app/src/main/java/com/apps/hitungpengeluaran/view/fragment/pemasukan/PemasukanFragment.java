package com.apps.hitungpengeluaran.view.fragment.pemasukan;
...
import com.apps.hitungpengeluaran.utils.FunctionHelper;
import com.apps.hitungpengeluaran.view.fragment.pemasukan.add.AddPemasukanActivity;
                ...
                new Observer<List<ModelDatabase>>() {
                    ...
                    public void onChanged(List<ModelDatabase> pemasukan) {
                        if (pemasukan.isEmpty()) {
                            ...
                            btnShared.setVisibility(View.GONE);
    ...
    private void initAction() {
        ...
        btnShared.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,"Total Pendapatan saya adalah "+tvTotal.getText().toString());
