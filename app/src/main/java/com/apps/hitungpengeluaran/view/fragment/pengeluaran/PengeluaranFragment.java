package com.apps.hitungpengeluaran.view.fragment.pengeluaran;
    ...
    private void initAction() {
        ...
        btnShared.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,"Total Pengeluaran saya adalah "+tvTotal.getText().toString());
